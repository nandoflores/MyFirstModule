# This Makefile is for the Acme::MyFirstModule::RAYMONDJM extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Acme/MyFirstModule/RAYMONDJM.pm]
#     AUTHOR => [q[A. U. Thor <a.u.thor@a.galaxy.far.far.away>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[Acme::MyFirstModule::RAYMONDJM]
#     PREREQ_PM => {  }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/Acme/MyFirstModule/RAYMONDJM.pm]
...
DIRFILESEP = \\
DFSEP = $(DIRFILESEP)
NAME = Acme::MyFirstModule::RAYMONDJM
NAME_SYM = Acme_MyFirstModule_RAYMONDJM
VERSION = 0.03
...
MAKE = dmake
FULLEXT = Acme\MyFirstModule\RAYMONDJM
BASEEXT = RAYMONDJM
PARENT_NAME = Acme::MyFirstModule
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Acme/MyFirstModule/RAYMONDJM.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
INST_LIBDIR      = $(INST_LIB)\Acme\MyFirstModule
INST_ARCHLIBDIR  = $(INST_ARCHLIB)\Acme\MyFirstModule
...
TO_INST_PM = lib/Acme/MyFirstModule/RAYMONDJM.pm

PM_TO_BLIB = lib/Acme/MyFirstModule/RAYMONDJM.pm \
	blib\lib\Acme\MyFirstModule\RAYMONDJM.pm
...
DISTNAME = Acme-MyFirstModule-RAYMONDJM
DISTVNAME = Acme-MyFirstModule-RAYMONDJM-0.03
...
RAYMONDJM.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"Acme::MyFirstModule::RAYMONDJM\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "name: Acme-MyFirstModule-RAYMONDJM" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "   }}," >> META_new.json
	$(NOECHO) $(ECHO) "   \"name\" : \"Acme-MyFirstModule-RAYMONDJM\"," >> META_new.json
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({{@ARGV}}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/Acme/MyFirstModule/RAYMONDJM.pm blib\lib\Acme\MyFirstModule\RAYMONDJM.pm 
